...
private:
    ...
    std::string/*wstring*/ get_date();

    void fetch_data(web::http::http_request message, const std::string/*wstring*/& postal_code, const std::string/*wstring*/& location);
    void get_data(web::http::http_request message, const std::string/*wstring*/& location);
